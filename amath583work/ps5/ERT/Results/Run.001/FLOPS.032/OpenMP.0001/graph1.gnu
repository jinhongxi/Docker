...
set nox2tics
set noy2tics
set title "Graph 1 (Results/Run.001/FLOPS.032/OpenMP.0001)"
...
set output "Results/Run.001/FLOPS.032/OpenMP.0001/graph1.pdf"
plot "Results/Run.001/FLOPS.032/OpenMP.0001/pre" using 2:4
#EOF

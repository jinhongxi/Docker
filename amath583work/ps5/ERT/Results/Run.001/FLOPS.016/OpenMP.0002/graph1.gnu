...
set nox2tics
set noy2tics
set title "Graph 1 (Results/Run.001/FLOPS.016/OpenMP.0002)"
...
set output "Results/Run.001/FLOPS.016/OpenMP.0002/graph1.pdf"
plot "Results/Run.001/FLOPS.016/OpenMP.0002/pre" using 2:4
#EOF

...
set nox2tics
set noy2tics
set title "Graph 4 (Results/Run.001/FLOPS.016/OpenMP.0002)"
...
set output "Results/Run.001/FLOPS.016/OpenMP.0002/graph4.pdf"
plot "Results/Run.001/FLOPS.016/OpenMP.0002/max" using 1:10 with linespoints pt 7 ps 0.4
#EOF

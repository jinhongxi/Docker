...
std::vector<std::pair<std::function<void(const Matrix& A, const Matrix& B, Matrix& C)>, const char*>> functionList{
    ...
    {hoistedCopyBlockedTiledMultiply2x2, "hoistedCopyBlockedTiledMultiply2x2"},
    {hoistedCopyBlockedTiledMultiply4x4, "hoistedCopyBlockedTiledMultiply4x4"},
#ifdef __AVX__
    {hoistedCopyBlockedTiledMultiply2x2AVX, "hoistedCopyBlockedTiledMultiply2x2AVX"},
    {hoistedCopyBlockedTiledMultiply4x4AVX, "hoistedCopyBlockedTiledMultiply4x4AVX"}
#endif    // __AVX__
};
...
int main() {
  ...
  for (auto& pf : functionList) {
    cout << pf.second << " " << frobeniusNorm(A) << " " << frobeniusNorm(B) << " " << frobeniusNorm(C) << " ";
    zeroize(D);
    pf.first(A, B, D);

...
double benchmark(size_t M, size_t N, size_t K, long numruns, function<void(const Matrix&, const Matrix&, Matrix&)>);
void runBenchmark(function<void(const Matrix&, const Matrix&, Matrix&)> f, long maxsize);

int main(int argc, char* argv[]) {
  long maxsize = (argc == 3) ? stod(argv[2]) : 4;
...
double benchmark(size_t M, size_t N, size_t K, long numruns, function<void(const Matrix&, const Matrix&, Matrix&)> f) {
